...
'''
Tk().withdraw()
filename = askopenfilename(initialdir = "/", filetypes = (("Excel files","*.xls"),("all files","*.*")))
print(filename)
...
rb1 = xlrd.open_workbook('u1.xls',formatting_info=False, on_demand=True)
sheet1 = rb1.sheet_by_index(list_num)
rb2 = xlrd.open_workbook('u2.xls',formatting_info=False, on_demand=True)
